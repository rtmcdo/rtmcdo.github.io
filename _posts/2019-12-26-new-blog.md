...
* Local development enviroment with a Static Site Generator, Azure DevOps Pipeline, and the site hosted in Azure
* Github Pages
...
If you aren't familar with [Github Pages](https://pages.github.com/), it provides a website hosted directly from your GitHub repository. Just edit, push, and your changes are live. The great thing about GitHub pages is it uses Jekyll on the backend for authoring pages. 
...
So I have to admit, the simplicity of GitHub pages won me over. It only took me about 30 minutes to get everything up and running with my custom domain name.


<h2 class="section-heading">Wrapping Up</h2>

As much fun as it was to build the website pipeline with Azure DevOps and host the site in Azure, the simpliity of GitHub Pages made it the right solution for the Azure I&O blog. 
