...
In addition to giving back to the technical community, I also had several other goals with the blog, which include:
...
As much fun as it was to build the website pipeline with Azure DevOps and to host the site in Azure, the simpliity of GitHub Pages made it the right solution for Azure I&O blog. 
